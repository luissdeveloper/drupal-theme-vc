...
if(!class_exists('element_gva_gmap')):
   class element_gva_gmap{
      ...
      public static function render_content( $attr = array(), $content = '' ){
       ...
       ?>
       <?php ob_start() ?>
         <script src="//maps.googleapis.com/maps/api/js?key&ver=4.9.8&libraries=places,weather,panoramio&language=en&ver=4.9.3"></script>
         <script type="text/javascript" src="<?php print (base_path() . drupal_get_path('theme', 'gavias_colin')) ?>/vendor/gmap3.js"></script>
         <script type="text/javascript" src="<?php print (base_path() . drupal_get_path('theme', 'gavias_colin')) ?>/vendor/jquery.ui.map.min.js"></script>
         ...
         <div class="gsc-map <?php print $el_class ?>" <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>>
            ...
            <div class="content-inner clearfix">
               ...
               <?php if($content){?><div class="address info"><span class="icon fas fa-map-marked-alt"></span><?php print $content ?></div> <?php } ?>
               <?php if($email){?><div class="email info"><span class="icon far fa-envelope"></span><?php print $email ?></div> <?php } ?>
               <?php if($phone){?><div class="phone info"><span class="icon fas fa-mobile-alt"></span><?php print $phone ?></div> <?php } ?>
